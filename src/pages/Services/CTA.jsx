      ...
      <div className="flex items-center space-x-4 flex-col md:flex-row gap-4">
        ...
        <div>
          ...
          <p className="text-sm md:text-lg font-medium">
            Contact us: <strong>1800 4250 788</strong> (365 days, 9am – 9pm IST)
          </p>
        </div>
      </div>
      <div className="flex flex-col  gap-4 mt-6 md:mt-0 ">
        <a
          href="tel:18004250788"
        ...
        <button className="bg-transparent border border-white text-white px-6 py-2 text-lg font-medium hover:bg-white md:text-xs hover:text-blue-800 transition duration-300">
          CONTACT US
        </button>
      </div>
    </div>
